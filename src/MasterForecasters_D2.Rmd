...
```{r irradiance-pair-plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r exogenous-pair-plot, echo=FALSE, message=FALSE, warning=FALSE}
...
(POA_LOG_DIFF_QQ + POA_LOG_DIFF_QQ)
```
...
# Comparisons
### TO DO:
- Plot the Naïve and Seasonal Mean against the actual POA for the first test period
- Calculat the MAE and RMSE for the Naïve and Seasonal Mean
